...
def btn_click(item):#btn_click function updates the input field whenever a number is entered. Any button pressed will act as a button click update:
    global expression
    expression = expression + str(item)
    input_text.set(expression)
    
def btn_clear():# btn_clear function clears the input field and previous calculations using the ’Clear’ button:
    global expression
    expression = ""
    input_text.set("")
